...
public class ILRuntimeInit : MonoBehaviour
{
    ...
    public static ILRuntimeInit ins;
    ...
    {
        isInitialized = false;
        StartCoroutine(ins.LoadHotFixAssembly());
    }
    ...
    public static void Invoke(string className, string method, params object[] args)
    {
        ins.appdomain.Invoke(className, method, null, args);
    }
}
